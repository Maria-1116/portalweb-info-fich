                ...
                <div class="row">
                    <form class="col s12">
                        <div class="row">
                            ...
                            <div class="input-field col s4">
                                <input id="solicitante" type="text" class="validate" name="solicitante" required>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/grupo01cc/portalweb-info-fich/resources/views/solicitud_reclamo/create.blade.php ENDPATH**/ ?>