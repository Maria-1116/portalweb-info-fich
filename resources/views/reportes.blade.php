...
@section('content')
    ...
    <script>
        ...
        const estadisticaPorPersona = async () => {
            try {
                const response = await fetch("{{ route('cantidad_solicitudes_por_persona') }}");
        ...
        const estadisticaPorFecha = async () => {
            try {
                const response = await fetch("{{ route('cantidad_solicitudes_por_fecha') }}");
        ...
        const estadisticaPorAnio = async () => {
            try {
                const response = await fetch("{{ route('cantidad_solicitudes_por_anio') }}");
